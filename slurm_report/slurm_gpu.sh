...
# when playing against Charlesworth PPO, use -pt 14 14 14 since the model was trained on ruleset of no increased penalty
# python3 train.py --actor_device_cpu --training_device cpu --opponent_agent ppo -pt 14 14 14
# python3 generate_eval_data.py
# python3 evaluate.py
srun python train.py --gpu_devices 0,1 --num_actor_devices 1 --num_actors 10 --training_device 1 -pt 14 14 14 --opponent_agent ppo
